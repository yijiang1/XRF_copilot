...
def reconstruction_worker_process(params: dict, status_queue, stop_event):
    ...
    try:
        ...
        if elem_symbols_str and len(element_lines_roi) > 0:
            ...
            # Build (symbol, shell) set from channel names (same logic as _detect_elements)
            selected_lines = set()
            ...
            # Build emission energy override from user-specified values
        ...
        recon_kwargs = dict(
            ...
            ini_rand_amp=params.get("ini_rand_amp", 0.1),
